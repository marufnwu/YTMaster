...
object Constant {
    ...
    const val IS_LINK_ADDEDD: String = "link_added"
    const val OTHER_PROFILE: String = "other_profile"
    const val SIGNING_ID_TOKEN = "signIing_id_token"
    const val SIGNING_EMAIl = "signIing_email"
    const val LINK = "Link"
